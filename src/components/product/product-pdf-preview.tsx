...
const ProductPdfPreviewInner = dynamic(
  ...
  { ssr: false, loading: () => <div className="animate-pulse h-[600px] bg-surface-alt rounded-xl border border-border flex items-center justify-center text-text-muted">Đang tải công cụ xem PDF...</div> }
);
